...
extension Category {
    ...
    static let shopping = Category(id: 9, name: "Shopping", icon: .shopping_cart)
    ...
    static let bankFree = Category(id: 401, name: "Bank Free", icon: .hand_holding_usd, mainCategoryId: 4)
    static let financeCharge = Category(id: 402, name: "Finance Charge", icon: .hand_holding_usd, mainCategoryId: 4)
    static let groceries = Category(id: 501, name: "Froceries", icon: .shopping_basket, mainCategoryId: 5)
